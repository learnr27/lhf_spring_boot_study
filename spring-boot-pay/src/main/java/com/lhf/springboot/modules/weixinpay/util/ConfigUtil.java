 ...
 * @Author: liuhefei
 * @Description: 相关配置参数
 * 接口文档地址：https://developers.weixin.qq.com/doc/offiaccount/Getting_Started/Overview.html
...
public class ConfigUtil {
    ...
    public static void commonParams(SortedMap<Object, Object> packageParams){
        ...
        String mch_id = ConfigUtil.MCH_ID;  //商户号
        //生成随机字符串
        String currTime = PayCommonUtil.getCurrenTime();
