package com.lhf.springboot.modules.weixinpay.service.impl;
...
import com.lhf.springboot.modules.weixinpay.service.WeixinPayService;
import com.lhf.springboot.modules.weixinpay.util.*;
...
public class WeixinPayServiceImpl implements WeixinPayService {
    ...
    public String weixinPay2(Product product) {
        ...
        try{
            ...
            packageParams.put("spbill_create_ip", product.getSpbillCreateIp());  //发起人的IP地址
            ...
            if("SUCCESS".equals(returnCode)){
                ...
                if("SUCCESS".equals(resultCode)){
                    ...
                    ConfigUtil.shorturl(urlCode);  //转化为短链接
                    //根据返回的code_url生成二维码
                    ZxingUtils.getQRCodeImge(urlCode, 256, imgPath);   //生成二维码
                }else {
                    String errCodeDes = (String)map.get("err_code_des");
                    logger.info("订单号：{}生成微信支付码失败: {}", product.getOutTradeNo(), errCodeDes);
    ...
    public void saveBill() {
        try{
            ...
            packageParams.put("bill_date", "20191213");  //账单日期
            String sign = PayCommonUtil.createSign("UTF-8", packageParams, key);
            packageParams.put("sign", sign);  //签名
    ...
    public String weixinPayH5(Product product) {
        ...
        try{
            ...
            value.put("type", "WAP");
            value.put("wap_url", "https://www.imooc.com/u/1323320/articles"); //WAP网站URL地址
            value.put("wap_name", "慕课网");  //WAP网站名
