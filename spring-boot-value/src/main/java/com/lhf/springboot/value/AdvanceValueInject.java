...
/**
 * @ClassName: AdvanceValueInject
 * @Author: liuhefei
 * @Description: 比较复杂的注入应用
 * @Date: 2019/7/24 16:40
 */
@Component  //com.lhf.springboot\advance_value_inject.properties
@PropertySource({"classpath:com.lhf.springboot/advance_value_inject.properties"})
