package com.lhf.springboot.echarts.api;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.lhf.springboot.echarts.api.model.BaseResponse;
import com.lhf.springboot.echarts.api.model.EchartsData;
...
public class PublicController {
    ...
    public ResponseEntity<BaseResponse> doJoin(HttpServletRequest request) throws Exception{
        logger.info("数据上传消息push接口 start。。。。");
